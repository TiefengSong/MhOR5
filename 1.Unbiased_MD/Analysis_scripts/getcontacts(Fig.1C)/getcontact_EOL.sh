/data/software/getcontacts/get_dynamic_contacts.py --topology step6.6_equilibration.gro --trajectory nopbc.xtc --itypes all --output MD_all.tsv --sele2 'resname EOL'
...
do
 ...
 Columns: frame, interaction_type, atom_1, atom_2[, atom_3[, atom_4]]" > MD_47${i}_all.tsv
               ...
               sed -i 's/X:EOL:474/X:LIG:999/g' MD_47${i}_all.tsv
               sed -i 's/X:EOL:475/X:LIG:999/g' MD_47${i}_all.tsv
              sed -i 's/X:EOL:476/X:LIG:999/g' MD_47${i}_all.tsv
               sed -i 's/X:EOL:477/X:LIG:999/g' MD_47${i}_all.tsv
done
